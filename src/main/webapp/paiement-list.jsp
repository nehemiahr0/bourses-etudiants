    ...
    <nav class="navbar navbar-expand-md navbar-dark" style="background-color: #4682b4;">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="https://img.icons8.com/material-rounded/24/000000/money.png"
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<%=request.getContextPath()%>/retardataires">Rétardataires</a>
                    </li>
                </ul>
            </div>
        </div>
...
<br>
    ...
    <hr>
    <div class="text-left">
        <a href="<%=request.getContextPath()%>/paiement/autre" class="btn btn-primary btn-lg">
            <i class="bi bi-plus"></i> Faire le paiement
        </a>
    </div>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped">
            ...
            <tr class="text-center" style="background-color: #fffff;">
                <th scope="col">ID PAYE</th>
                <th scope="col">Matricule</th>
                <th scope="col">Année-Universitaire</th>
                <th scope="col">Date</th>
                <th scope="col">Nombres de Mois</th>
                <th scope="col">Actions</th>
            </tr>
            </thead>
            <tbody>
            <c:forEach var="paiement" items="${listPaiement}">
                <tr class="text-center">
                    <td><c:out value="${paiement.idpaye}" /></td>
                    <td><c:out value="${paiement.matricule}" /></td>
                    <td><c:out value="${paiement.annee_univ}" /></td>
                    <td><c:out value="${paiement.date}" /></td>
                    <td><c:out value="${paiement.nbr_mois }"/></td>
                    <td class="btn-container">
                                   
                        <a href="<%=request.getContextPath()%>/paiement/pdf?idpaye=${paiement.idpaye}" 
                        class="btn btn-success btn-action">
                        <i class="bi bi-file-pdf"></i> 
                        </a>
                        
                        <a href="<%=request.getContextPath()%>/paiement/editer?idpaye=${paiement.idpaye}"
                           class="btn btn-info btn-action">
                            <i class="bi bi-pencil"></i>
                        </a>
                        
                        <a href="<%=request.getContextPath()%>/paiement/effacer?idpaye=${paiement.idpaye}"
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js"
        integrity="sha384-UO2eT0CpHqdSJQ6hJty5KVphtPhzWj9WO1clHTMGa5mNEOFRPRm11J0TCM6XE6J6"
        crossorigin="anonymous"></script>
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"
        integrity="sha384-pjaaA8dDz/6Ik5h1T+0s0kMHDQa5xlgk5aix0vBJ0l3xSxss3Uek/2azZkgxVygE"
        crossorigin="anonymous"></script>
</body>
</html>
